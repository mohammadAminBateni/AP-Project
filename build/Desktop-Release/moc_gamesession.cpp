...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_GameSession_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_GameSession_t qt_meta_stringdata_GameSession = {
    {
        QT_MOC_LITERAL(0, 11)   // "GameSession"
    },
    "GameSession"
};
...
Q_CONSTINIT static const uint qt_meta_data_GameSession[] = {
...
Q_CONSTINIT const QMetaObject GameSession::staticMetaObject = { {
    ...
    qt_meta_stringdata_GameSession.offsetsAndSizes,
    qt_meta_data_GameSession,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_GameSession_t,
        // Q_OBJECT / Q_GADGET
